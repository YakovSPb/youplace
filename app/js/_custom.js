  ...
  modalWindowHtml = `
        <form class="form popup-form callback zoom-anim-dialog" id="callback">
         ...
         <div class="radio-toolbar">
            ...
            <input type="radio" id="radioEmail" name="radioCall" value="email">
...
specialistsBtn[i].addEventListener('click', function(e){
  let specialistImages = e.target.querySelector('.specialists-item__img img');
...
function renderMap(){
     modalWindowHtml = `
    <div class="map">
    <img src="img/@2x/map.jpg" alt="map" />
    </div>
   `
 modalBody.innerHTML = modalWindowHtml;
 openModal();
